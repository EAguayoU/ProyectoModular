...
internal class clSvgBuilder {
    private val mSvgPathsBuilder = StringBuilder()
    private var mCurrentPathBuilder: clSvgPathBuilder? = null
    fun clear() {
    ...
    fun append(curve: clBezier, strokeWidth: Float): clSvgBuilder {
    ...
    private fun startNewPath(roundedStrokeWidth: Int, curveStartSvgPoint: SvgPoint) {
        mCurrentPathBuilder = clSvgPathBuilder(curveStartSvgPoint, roundedStrokeWidth)
    }
